    ...
    <nav class="main-header navbar navbar-expand navbar-dark  ">
      ...
      <ul class="navbar-nav">
        ...
        <li class="<?php
                    ...
                    ?>" style="display: none;">
<<<<<<< HEAD
          <a href="pages/compras/compra-list.php" class="nav-link">Lista de Compras</a>
        </li>
        <li class="<?php
...
=======
          <a href="pages/deposito/deposito-list.php" class="nav-link">Depósito</a>
        </li>
...
=======
          <a href="pages/vendas/venda-list.php" class="nav-link">Minhas vendas</a>
>>>>>>> 8299d9c942806660d930784a5c8f6b0bb883c73f
        </li>
