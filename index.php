...
$grafico = Movimentacao::getList('(CASE month(m.data) 
when 1 then "Janeiro"
...
END) AS mes, SUM(m.valor) as total', 'movimentacoes as m Where m.data >= current_date() group by m.data >= current_date()', null, null, null);
